...
"""Reading in video frame by frame"""

"""

frame_width = 320
frame_height = 180
video_path = "Real_Car_Images_And_Videos/Bay_Area_Videos/Highway_280_3-31-2018.mp4"
#cap = cv2.VideoCapture(0) # for reading frames live video
#cap = cv2.VideoCapture(video_path) # for reading frames from recorded video
